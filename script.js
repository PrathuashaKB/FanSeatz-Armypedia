/*If you would like to prefer using a separate/external JavaScript file, make use of this file and save it ith .js extension. Further within the <head> section of HTML file(index.html) add the address of the JavaScript file :
